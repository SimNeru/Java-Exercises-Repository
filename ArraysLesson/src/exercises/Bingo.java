...
public class Bingo {
	...
	public static void main(String[] args) {
		...
		// estraggo randomicamente l'indice della lista di numeri di partenza, assieme all'elemento presente in quella posizione
		// aggiungo l'elemento presente alla seconda lista di numeri estratti e lo rimuovo dalla lista precedente
		...
		/*
		// SISTEMA 1: popolo la lista di numberi finché non differiscono da numeri già presenti
